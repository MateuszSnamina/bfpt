...
TEST(Kstate, CompareTest0) {
  ...
  const auto k1 = kstate::SimpleKstate<int>(v1, 42l);
  const auto k2 = kstate::SimpleKstate<int>(v2, 42l);
...
TEST(Kstate, TranlationalCompareTest0) {
  ...
  const auto k1 = kstate::SimpleKstate<int>(v1, 42l);
  const auto k2 = kstate::SimpleKstate<int>(v2, 42l);
  const auto k11 = kstate::SimpleKstate<int>(v11, 42l);
  const auto k12 = kstate::SimpleKstate<int>(v12, 42l);
  const auto k13 = kstate::SimpleKstate<int>(v13, 42l);
  const auto k14 = kstate::SimpleKstate<int>(v14, 42l);
  const auto k15 = kstate::SimpleKstate<int>(v15, 42l);
...
//   int v2[1] = {11};
//   const auto k2 = kstate::SimpleUniqueKstate<int>(v2, 42l);
//   EXPECT_EQ(k2.to_str(), "⦃11⦄");
// }
