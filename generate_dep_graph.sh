...
pushd build_debug_for_dep_graph && dot -Tpng fig-dep-all.dot -o ../fig-dep-all.png && popd
...
pushd build_debug_for_dep_graph && dot -Tpng fig-dep-no-enxternal.dot -o ../fig-dep-no-enxternal.png && popd
