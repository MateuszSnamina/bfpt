...
double AcosPlusBsinPlusZ::get_value(double phi) const {
    return +_cos_coef * std::cos(phi) + _sin_coef * std::sin(phi) + _free_coef;
}
...
double BsinPlusCsqcosPlusZ::get_value(double phi) const {
    return +_sin_coef * std::sin(phi) + _sqcos_coef * std::cos(phi) * std::cos(phi) + _free_coef;
}
...
double AcosPlusCsqcosPlusZ::get_value(double phi) const {
    return +_cos_coef * std::cos(phi) + _sqcos_coef * std::cos(phi) * std::cos(phi) + _free_coef;
}
