...
class BasisStreamer {
   ...
   public:  // Factory function:
    friend BasisStreamer<BasisT> make_basis_streamer<BasisT>(BasisT&&, const extension::boost::RangeStreamerSettings<KstateT>);
...
BasisStreamer<_BasisT>::BasisStreamer(
    ...
    extension::boost::RangeStreamerSettings<KstateT> range_streamer_settings) : _basis(std::forward<_BasisT>(basis)),
