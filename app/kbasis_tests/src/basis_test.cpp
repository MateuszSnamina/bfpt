...
TEST(Basis, BigTestWithUniqueStates) {
    ...
    // test finding the existing elements:
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k0->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v0 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v0 | kstate_view_amend_spec::rotated(1)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v0 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k1->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v1 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v1 | kstate_view_amend_spec::rotated(1)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v1 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k2->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v2 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v2 | kstate_view_amend_spec::rotated(1)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v2 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k3->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v3 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v3 | kstate_view_amend_spec::rotated(1)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v3 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k4->to_range()));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v4 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v4 | kstate_view_amend_spec::rotated(1)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v4 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k5->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v5 | kstate_view_amend_spec::rotated(0)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v5 | kstate_view_amend_spec::rotated(1)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v5 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k6->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v6 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v6 | kstate_view_amend_spec::rotated(1)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v6 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k7->to_range()));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v7 | kstate_view_amend_spec::rotated(0)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v7 | kstate_view_amend_spec::rotated(1)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v7 | kstate_view_amend_spec::rotated(2)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(k8->to_range()));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v8 | kstate_view_amend_spec::rotated(0)));
    ASSERT_TRUE(basis.find_element_and_get_its_ra_index(v8 | kstate_view_amend_spec::rotated(1)));
    ASSERT_FALSE(basis.find_element_and_get_its_ra_index(v8 | kstate_view_amend_spec::rotated(2)));
    EXPECT_EQ(*basis.find_element_and_get_its_ra_index(k0->to_range()), 0);
    EXPECT_EQ(*basis.find_element_and_get_its_ra_index(k1->to_range()), 1);
    EXPECT_EQ(*basis.find_element_and_get_its_ra_index(k2->to_range()), 2);
    EXPECT_EQ(*basis.find_element_and_get_its_ra_index(k3->to_range()), 2);
