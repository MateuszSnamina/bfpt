...
#include <monostar_app/interpret_run_type_string.hpp>
...
RawProgramOptions grep_program_options(int argc, char** argv) {
    ...
    desc.add_options()
        ...
        // --hamiltonian_K:
        ("hamiltonian_K",
         boost::program_options::value<double>(&program_options.hamiltonian_K)->default_value(0.0))
        // --hamiltonian_K_0:
        ("hamiltonian_K_0",
        ...
        // --hamiltonian_eps:
        ("hamiltonian_eps",
         boost::program_options::value<double>(&program_options.hamiltonian_agile_eps)->default_value(0.0))
        // --hamiltonian_phi:
        ("hamiltonian_phi",
         boost::program_options::value<double>(&program_options.hamiltonian_agile_phi)->default_value(0.0))
        // --orbital_theta,o:
        ("orbital_theta,o",
