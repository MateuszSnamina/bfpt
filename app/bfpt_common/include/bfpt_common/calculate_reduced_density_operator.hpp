...
//        //////const auto ket_kernel_site_1 = *std::next(std::begin(ket_kstate_view), n_delta); //TODO remove
//        //////const auto ket_kernel_site_2 = *std::next(std::begin(ket_kstate_view), n_delta_p1); //TODO remove
