...
chainkernel::OperatorKernel12<so_system::SoSiteStateTrait>
prepare_hamiltonian_kernel_12_af_fo(const HamiltonianParamsAfFo&, double orbital_theta);
...
chainkernel::OperatorKernel1<so_system::SoSiteStateTrait>
prepare_hamiltonian_kernel_1_af_fo(const HamiltonianParamsAfFo&, double orbital_theta);
