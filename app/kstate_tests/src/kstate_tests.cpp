...
TEST(DynamicKstate, CompareTest0) {
    ...
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k1(v1, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k2(v2, ctr_from_range);
...
TEST(DynamicKstate, TranlationalCompareTest0) {
    ...
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k1(v1, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k2(v2, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k11(v11, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k12(v12, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k13(v13, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k14(v14, ctr_from_range);
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k15(v15, ctr_from_range);
    // ---
...
TEST(DynamicKstate, LeastReplicationShiftTest2) {
    ...
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k3(v3, ctr_from_range);
...
TEST(DynamicKstate, LeastReplicationShiftTest3) {
    ...
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k4(v4, ctr_from_range);
...
TEST(DynamicUniqueKstate, CtrTest0) {
    const std::array<int, 1> v2 = {11};
    const kstate::DynamicKstate<kstate::TraitSiteState<int>> k2(kstate::make_unique_shift(v2), ctr_from_range);
    EXPECT_EQ(k2.to_str(), "⦃11⦄");
}
